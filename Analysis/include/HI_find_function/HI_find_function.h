#ifndef _HI_FIND_FUNCTION
#define _HI_FIND_FUNCTION
...
class HI_find_functions : public ModulePass
{
public:
    HI_find_functions() : ModulePass(ID)
    {
    ...
    {
        print_status("Initilizing HI_find_functions pass.");
