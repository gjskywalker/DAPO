#ifndef _HI_LOOP_INFORMATION_COLLECT
#define _HI_LOOP_INFORMATION_COLLECT
...
class HI_loop_information_collect : public LoopPass
{
public:
    HI_loop_information_collect(const char *loopfile) : LoopPass(ID)
    {
    ...
    {
        std::string tmpInfo = std::string("Initilizing HI_loop_information_collect pass for Loop ") + L->getName().str();
