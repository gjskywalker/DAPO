#ifndef _HI_QOR_ESTIMATOR
#define _HI_QOR_ESTIMATOR
...
class HI_qor_estimator : public ModulePass
{
public:
    // Pass for simple evluation of the latency of the top function, without considering HLS
    // directives
    HI_qor_estimator(const char *config_file_name, const char *evaluating_log_name,
    ...
    virtual bool doInitialization(Module &M)
    {
        ...
        print_status("Initilizing HI_qor_estimator pass.");
        Loop_id.clear();
        InstructionCP.clear();
        LoopLatency.clear();
        BlockLatency.clear();
