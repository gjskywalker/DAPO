...
private:
  ...
  APInt findInEitherOperand(llvm::BinaryOperator *BO, bool SignExtended, bool ZeroExtended);
  ...
  ///                array index.
  bool CanTraceInto(bool SignExtended, bool ZeroExtended, llvm::BinaryOperator *BO, bool NonNegative);
