...
void HI_duplicate_inst_rm::getAnalysisUsage(AnalysisUsage &AU) const
{
...
Instruction *HI_duplicate_inst_rm::checkDuplicationInBlock(BasicBlock *B, Instruction *I)
{
