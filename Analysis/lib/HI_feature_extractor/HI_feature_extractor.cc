...
bool HI_feature_extractor::runOnModule(
...
bool HI_feature_extractor::Is_InLoop(BasicBlock &BB)
{
    BasicBlock *BB_ptr = &BB;
    return (Block2Loops.find(BB_ptr) != Block2Loops.end());
}

void HI_feature_extractor::initNode(Node &node)
{
    node.name = "";
...
void HI_feature_extractor::getLoopBlockMap(Function *F)
{
    Block2Loops.clear();
...
void HI_feature_extractor::DitoBi(Node &node, int num)
{
...
int HI_feature_extractor::getvarwidth(Instruction *I)
{
    int bitwidth;
...
int HI_feature_extractor::getPointerBitwidth(Instruction *I)
{
...
void HI_feature_extractor::CountBB(BasicBlock &BB, Node &node)
{
...
void HI_feature_extractor::ClassifyInst(Instruction &I, Node &node)
{
...
void HI_feature_extractor::CountInstr(Instruction &I, Node &node)
{
    ////////////////////////////// Cast Operations /////////////////////////
...
void HI_feature_extractor::getAnalysisUsage(AnalysisUsage &AU) const
{
    AU.setPreservesAll();
