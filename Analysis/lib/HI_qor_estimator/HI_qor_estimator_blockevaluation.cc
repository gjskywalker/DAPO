...
HI_qor_estimator::BlockLatencyResourceEvaluation(BasicBlock *B)
{
...
*/
bool HI_qor_estimator::BlockContain(BasicBlock *B, Instruction *I)
{
...
*/
int HI_qor_estimator::getFunctionLatencyInPath(Instruction *I)
{
    /*
...
int HI_qor_estimator::getStageTo(Instruction *I)
{
...
int HI_qor_estimator::getStageNumOfBlock(BasicBlock *B)
{
