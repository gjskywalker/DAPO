#include "HI_instruction_files.h"
...
void HI_qor_estimator::Parse_Config()
{
    std::string tmp_s;
...
void HI_qor_estimator::Load_Instruction_Info()
{
    int i;
...
HI_qor_estimator::timingBase
HI_qor_estimator::get_inst_TimingInfo_result(std::string opcode,
                                                                   int operand_bitwid,
                                                                   int res_bitwidth,
                                                                   std::string period)
{
...
HI_qor_estimator::resourceBase
HI_qor_estimator::get_inst_ResourceInfo_result(std::string opcode,
                                                                     int operand_bitwid,
                                                                     int res_bitwidth,
                                                                     std::string period)
{
...
HI_qor_estimator::inst_timing_resource_info
HI_qor_estimator::get_inst_info(std::string opcode, int operand_bitwid,
...
bool HI_qor_estimator::checkInfoAvailability(std::string opcode,
                                                                   int operand_bitwid,
                                                                   int res_bitwidth,
                                                                   std::string period)
{
...
bool HI_qor_estimator::checkFreqProblem(std::string opcode,
...
// frequency
HI_qor_estimator::inst_timing_resource_info
HI_qor_estimator::checkInfo_HigherFreq(std::string opcode, int operand_bitwid,
                                                             int res_bitwidth, std::string period)
{
    int i;
...
// int HI_qor_estimator::get_N_DSP(std::string opcode, int operand_bitwid ,
// int res_bitwidth, std::string period)
// {
//     if (checkInfoAvailability( opcode, operand_bitwid , res_bitwidth, period))
...
// int HI_qor_estimator::get_N_FF(std::string opcode, int operand_bitwid , int
...
// int HI_qor_estimator::get_N_LUT(std::string opcode, int operand_bitwid ,
// int res_bitwidth, std::string period)
// {
//     if (checkInfoAvailability( opcode, operand_bitwid , res_bitwidth, period))
...
// int HI_qor_estimator::get_N_Lat(std::string opcode, int operand_bitwid ,
// int res_bitwidth, std::string period)
// {
//     if (checkInfoAvailability( opcode, operand_bitwid , res_bitwidth, period))
...
// double HI_qor_estimator::get_N_Delay(std::string opcode, int operand_bitwid
// , int res_bitwidth, std::string period)
// {
//     if (checkInfoAvailability( opcode, operand_bitwid , res_bitwidth, period))
