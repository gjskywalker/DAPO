...
HI_qor_estimator::analyzeFunction(Function *F)
{
...
*/
void HI_qor_estimator::analyzeFunction_traverseFromEntryToExiting(
    HI_qor_estimator::timingBase tmp_critical_path, Function *F,
    BasicBlock *curBlock, HI_qor_estimator::resourceBase &resourceAccumulator)
{
...
int HI_qor_estimator::getFunctionStageNum(
    HI_qor_estimator::timingBase tmp_critical_path, Function *F,
    BasicBlock *curBlock)
{
...
HI_qor_estimator::getFunctionResource(Function *F)
{
