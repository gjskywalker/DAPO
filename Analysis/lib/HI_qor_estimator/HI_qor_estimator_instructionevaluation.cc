...
HI_qor_estimator::getInstructionLatency(Instruction *I)
{
...
bool HI_qor_estimator::canChainOrNot(Instruction *PredI, Instruction *I)
{
...
bool HI_qor_estimator::isMACpossible(Instruction *PredI, Instruction *I)
{
...
bool HI_qor_estimator::isAMApossible(Instruction *PredI, Instruction *I)
{
...
int HI_qor_estimator::getOriginalBitwidth(Value *Val)
{
...
int HI_qor_estimator::getActualUsersNum(Instruction *I, int dep)
{
...
HI_qor_estimator::getInstructionResource(Instruction *I)
{
...
Instruction *HI_qor_estimator::byPassUnregisterOp(Instruction *cur_I)
{
...
// trace back to find the original operator, bypassing SExt and ZExt operations
Value *HI_qor_estimator::byPassBitcastOp(Instruction *cur_I)
{
...
// trace back to find the original operator, bypassing SExt and ZExt operations
Value *HI_qor_estimator::byPassBitcastOp(Value *cur_I_value)
{
...
bool HI_qor_estimator::checkLoadOpRegisterReusable(Instruction *Load_I,
                                                                         int time_point)
{
...
// a register
void HI_qor_estimator::updateResultRelease(Instruction *I,
                                                                 Instruction *I_Pred,
                                                                 int time_point)
{
...
int HI_qor_estimator::getPointerBitwidth(Instruction *I)
{
