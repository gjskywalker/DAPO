...
bool HI_qor_estimator::isInLoop(BasicBlock *BB)
{
...
*/
Loop *HI_qor_estimator::getOuterLoopOfBlock(BasicBlock *B)
{
...
void HI_qor_estimator::getLoopBlockMap(Function *F)
{
...
*/
Loop *HI_qor_estimator::getInnerUnevaluatedLoop(Loop *outerL)
{
    int dep = 0;
...
HI_qor_estimator::analyzeOuterLoop(Loop *outerL)
{
...
*/
void HI_qor_estimator::LoopLatencyResourceEvaluation_traversFromHeaderToExitingBlocks(
    HI_qor_estimator::timingBase tmp_critical_path, Loop *L, BasicBlock *curBlock,
    HI_qor_estimator::resourceBase &resourceAccumulator)
{
...
*/
void HI_qor_estimator::MarkBlock_traversFromHeaderToExitingBlocks(
    HI_qor_estimator::timingBase total_latency, Loop *L, BasicBlock *curBlock)
{
    BlockVisited.insert(curBlock);
...
int HI_qor_estimator::getLoopTripCount(ScalarEvolution *SE, Loop *L)
{
    int tripcount;
