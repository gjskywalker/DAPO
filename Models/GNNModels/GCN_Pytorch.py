...
from torch_geometric.nn import global_mean_pool, GCNConv, summary
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
                    usage='python GCN_Pytorch.py --epochs 200 --patience 3',
                    description='Train GCN')
    ...
    print("Graph data size", len(graph_data))
    print("Graph pair index size", len(graph_pair_idx))
    ...
    for epoch in range(num_epochs):
        ...
        if epoch_loss < best_loss:
            ...
            torch.save({
                ...
                'loss': best_loss,
                }, 'models/Embedding_model_GCNConv.pth')
    ...
    plt.savefig('losses/GCN_URG.png')
    plt.show()
