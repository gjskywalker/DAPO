...
if __name__ == "__main__":
    ...
    with open('/home/eeuser/Desktop/GRL-HLS/GNNRL/GNN_Model/GED_Result_Harp/Harp_indexes.pkl', 'rb') as fp:
        graph_pair_idx = pickle.load(fp)
    with open('/home/eeuser/Desktop/GRL-HLS/GNNRL/GNN_Model/GED_Result_Harp/Harp_GED_Result.pkl', 'rb') as fp:
        targets = pickle.load(fp)
    
    fp = open("/home/eeuser/Desktop/GRL-HLS/GNNRL/GNN_Model/Graph_Harp/graphs_random_dataset_harp.pkl", "rb")
    ...
    in_channels = 145 
    out_channels = 32
    model = GCCGraphInfer(in_channels, out_channels, edge_dim=14)
